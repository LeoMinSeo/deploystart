...
const MyPageDelete = ({ userId }) => {
 ...
 <div className="flex justify-end ml-0 lg:ml-[1rem] mt-0 lg:mt-[0.5rem] min-h-[92vh] select-none">
   <div className="bg-white p-4 lg:p-8 rounded-lg shadow-lg lg:mt-20 w-full">
     ...
     <div className="w-4/5 pl-8 lg:pl-32 mb-8">
     ...
     <p className="text-lg lg:text-xl text-gray-800 mb-2 pl-8 lg:pl-32 text-left">
       계정을 삭제하시려는 이유를 말씀해주세요.사이트 개선에 중요 자료로
       활용됩니다
       <p className="text-sm lg:text-base font-light text-gray-800 mb-2 ">
     ...
     <div>
       {[
         ...
         <label key={index} className="flex items-left cursor-pointer pl-8 lg:pl-32">
           <input
             type="checkbox"
     ...
     <div className="pl-8 lg:pl-32 w-full">
       <p className="text-lg lg:text-xl text-gray-800 mb-2 mt-8 text-left">
         현재 사용 중인 비밀번호
       </p>
       <input
         type="password"
         ...
         className="w-full lg:w-3/5 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 ease-in-out"
       />
     </div>
     <div className="pl-8 lg:pl-32 w-full">
       <button
         className={`w-full lg:w-3/5 py-2 mt-4 rounded ${
     ...
     {showModal && (
       <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
         <div className="bg-white p-6 rounded-lg shadow-md w-80 lg:w-96 mx-4">
